...
- **Base URL** is `https://api.iblai.app/dm`, and every request carries `Authorization: Api-Token $IBLAI_API_KEY`. See [`/iblai-api-login`](../skills/start/iblai-api-login/SKILL.md) for how to obtain the token.
