...
![Project landing](https://raw.githubusercontent.com/iblai/vibe/refs/heads/main/skills/iblai-vibe-project/iblai-vibe-project-1-landing.png)
![Project files modal](https://raw.githubusercontent.com/iblai/vibe/refs/heads/main/skills/iblai-vibe-project/iblai-vibe-project-2-files-modal.png)
...
```bash
pnpm add @iblai/iblai-js@^2.5.10 @iblai/agent-ai@^2.8.1
```
