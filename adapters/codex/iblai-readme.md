...
# CI: copy assets/tauri/workflows/tauri-build-ios.yml.j2 (see /iblai-ops-build)                 # generate App Store CI
```
...
- `/iblai-profile` — user profile
- `/iblai-account` — account/org settings
- `/iblai-analytics` — analytics dashboard
- `/iblai-notification` — notification bell
- `/iblai-invite` — invite dialogs
