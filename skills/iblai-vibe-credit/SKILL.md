...
- Navbar must be in place (`/iblai-vibe-navbar`)
...
If the app scans through a `lib/iblai/sdk` symlink instead (some older
scaffolds ship one), the equivalent is:
