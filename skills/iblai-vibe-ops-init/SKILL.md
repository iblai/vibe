...
`/iblai-vibe-auth`, `/iblai-vibe-navbar`, `/iblai-vibe-profile`, `/iblai-vibe-account`, and
`/iblai-vibe-notification` skills.
...
to vibe-starter** below. Only fall back to a vanilla Next.js app wired up
via the `/iblai-vibe-*` skills if the user explicitly declines the starter or
...
manual `/iblai-vibe-auth`, `/iblai-vibe-navbar`, `/iblai-vibe-profile`, `/iblai-vibe-account`,
and `/iblai-vibe-notification` skills.
...
/iblai-vibe-course-access # Course content pages (edX user UI)
