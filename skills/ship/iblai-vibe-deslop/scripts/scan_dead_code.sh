...
find "$DIR" \( -name "*.js" -o -name "*.ts" -o -name "*.tsx" -o -name "*.jsx" \) 2>/dev/null | grep -v node_modules | grep -v dist | grep -v build | grep -v ".d.ts" | while read -r f; do
...
find "$DIR" -name "*.py" 2>/dev/null | grep -v __pycache__ | grep -v venv | grep -v .venv | grep -v site-packages | while read -r f; do
...
find "$DIR" \( -name "*.js" -o -name "*.ts" -o -name "*.tsx" -o -name "*.jsx" \) 2>/dev/null | grep -v node_modules | grep -v dist | grep -v build | while read -r f; do
...
find "$DIR" \( -name "*.js" -o -name "*.ts" -o -name "*.py" -o -name "*.java" -o -name "*.go" -o -name "*.rb" \) 2>/dev/null | grep -v node_modules | grep -v __pycache__ | grep -v venv | while read -r f; do
