...
A production-ready learning and skills-management platform that connects users
...
- **Skills & competency tracking** — a skill inventory with proficiency levels (0–5)
  and skill points from course/unit completions; skill leaderboards across users
...
- **Programs & learning pathways** — multi-course programs with progress tracking and
  ...
  users and orgs can build and share custom pathways.
- **User profile & analytics** — activity dashboard (courses enrolled/completed,
...
- **Admin analytics** — platform-wide usage/engagement overview, per-user
...
- **Enterprise & platform** — per-org isolation (config, branding, users); granular
  ...
  conversational AI-agent sidebar that helps users as they learn; configurable onboarding with
