...
2. **Compute the slug.** Run:
   ```bash
   node .claude/skills/iblai-vibe-design/scripts/critique-storage.mjs slug "<resolved-path-or-url>"
   ```
...
- **Suggested command**: Which command could address this (from: /iblai-vibe-design adapt, /iblai-vibe-design animate, /iblai-vibe-design audit, /iblai-vibe-design bolder, /iblai-vibe-design clarify, /iblai-vibe-design colorize, /iblai-vibe-design critique, /iblai-vibe-design delight, /iblai-vibe-design distill, /iblai-vibe-design document, /iblai-vibe-design harden, /iblai-vibe-design layout, /iblai-vibe-design onboard, /iblai-vibe-design optimize, /iblai-vibe-design overdrive, /iblai-vibe-design polish, /iblai-vibe-design quieter, /iblai-vibe-design shape, /iblai-vibe-design typeset)
...
Once the report above is finalized, write it to `.impeccable/critique/` so the user can refer back, and so `/iblai-vibe-design polish` can pick up the priority issues without a copy-paste.
...
2. **Pass the structured metadata** through `IMPECCABLE_CRITIQUE_META` (JSON), then run the write command:
   ...
   IMPECCABLE_CRITIQUE_META='{"target":"<user phrasing>","total_score":<n>,"p0_count":<n>,"p1_count":<n>}' \
     node .claude/skills/iblai-vibe-design/scripts/critique-storage.mjs write <slug> <body-file>
   ```
   The helper prints the absolute path it wrote.

3. **Read the trend** for context:
   ```bash
   node .claude/skills/iblai-vibe-design/scripts/critique-storage.mjs trend <slug> 5
   ```
...
- Only recommend commands from: /iblai-vibe-design adapt, /iblai-vibe-design animate, /iblai-vibe-design audit, /iblai-vibe-design bolder, /iblai-vibe-design clarify, /iblai-vibe-design colorize, /iblai-vibe-design critique, /iblai-vibe-design delight, /iblai-vibe-design distill, /iblai-vibe-design document, /iblai-vibe-design harden, /iblai-vibe-design layout, /iblai-vibe-design onboard, /iblai-vibe-design optimize, /iblai-vibe-design overdrive, /iblai-vibe-design polish, /iblai-vibe-design quieter, /iblai-vibe-design shape, /iblai-vibe-design typeset
...
- End with `/iblai-vibe-design polish` as the final step if any fixes were recommended

After presenting the summary, tell the user:

> You can ask me to run these one at a time, all at once, or in any order you prefer.
>
> Re-run `/iblai-vibe-design critique` after fixes to see your score improve.
