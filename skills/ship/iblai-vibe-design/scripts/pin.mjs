...
This is a pinned shortcut for \`/iblai-vibe-design ${command}\`.

Invoke /iblai-vibe-design ${command}, passing along any arguments provided here, and follow its instructions.
`;
}
