...
- [/iblai-vibe-monetization](../iblai-vibe-monetization) — overview, schema-validation pattern.
- [/iblai-vibe-monetization-onboard](../iblai-vibe-monetization-onboard) — `is_ready_for_payments`, commission_percent source.
- [/iblai-vibe-monetization-configure](../iblai-vibe-monetization-configure) — paywall + price CRUD that produces the `price_id` you charge.
- [/iblai-vibe-monetization-subscription](../iblai-vibe-monetization-subscription) — what the subscription row looks like after callback / webhook completes.
