...
- No subscription state — see `/iblai-vibe-monetization-subscription`.
...
- [/iblai-vibe-monetization-checkout](../SKILL.md) — full checkout flow
- [/iblai-vibe-monetization-configure](../../iblai-vibe-monetization-configure) —
  where Platform admins create the paywall config + prices this
  endpoint returns
- [/iblai-vibe-monetization](../../iblai-vibe-monetization) — family index and
