...
| Status | When |
|---|---|
| 400 | `enforce_can_sell_items` fails — Stripe Connect not ready. Run `/iblai-vibe-monetization-onboard` first. |
...
- [/iblai-vibe-monetization-configure → references/prices-api.md](./prices-api.md)
- [/iblai-vibe-monetization-configure → references/wizard-state-machine.md](./wizard-state-machine.md)
- [/iblai-vibe-monetization](../../iblai-vibe-monetization) — item-type normalization and platform flags.
- [/iblai-vibe-monetization-onboard](../../iblai-vibe-monetization-onboard) — the Stripe Connect prerequisite.
- [/iblai-vibe-monetization-checkout](../../iblai-vibe-monetization-checkout) — what `allow_free_tier`, `trial_period_days`, and the prices array drive on the buyer side.
