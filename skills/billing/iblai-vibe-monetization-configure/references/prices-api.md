...
configuration and [/iblai-vibe-monetization-checkout](../../iblai-vibe-monetization-checkout)
...
`/iblai-vibe-monetization-analytics` shows an active-price count per item, so it
needs to refresh whenever a price is added, edited, or removed.

## Related skills

- [/iblai-vibe-monetization](../../iblai-vibe-monetization) — family index, schema-validation routine
- [/iblai-vibe-monetization-checkout](../../iblai-vibe-monetization-checkout) — `PaywallModal` consumer
- [/iblai-vibe-monetization-onboard](../../iblai-vibe-monetization-onboard) — Stripe Connect prerequisite
- [/iblai-vibe-monetization-analytics](../../iblai-vibe-monetization-analytics) — paywalls list with active-price counts
