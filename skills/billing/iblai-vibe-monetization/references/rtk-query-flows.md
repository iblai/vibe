...
- **URL → hook + RBAC mapping**: see `/iblai-vibe-monetization` → `rbac-matrix.md`
- **402-as-success in practice**: see `/iblai-vibe-monetization-checkout`
- **Cancel branching UI**: see `/iblai-vibe-monetization-subscription`
- **Stripe Connect onboarding**: see `/iblai-vibe-monetization-onboard`
- **Schema validation routine**: see `/iblai-vibe-monetization` → `schema-validation.md`
