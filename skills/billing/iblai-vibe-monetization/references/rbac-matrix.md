...
- `/iblai-vibe-monetization` — family index and SKILL overview.
- `/iblai-vibe-rbac` — generic RBAC primer (the CRM-style decorator stack
  monetization does NOT use).
- `/iblai-vibe-auth` — token wiring for `IsEdxAuthenticated` and
