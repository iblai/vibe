...
| Authentication | SSO authentication | `/iblai-vibe-auth` |
| Agent chat | Full in-process agent chat surface | `/iblai-vibe-agent-chat` |
| Profile | User profile dropdown | `/iblai-vibe-profile` |
| Account | Account/organization settings | `/iblai-vibe-account` |
| Analytics | Analytics dashboard | `/iblai-vibe-analytics` |
| Notifications | Notification bell | `/iblai-vibe-notification` |
| Invitations | User invitation dialogs | `/iblai-vibe-invite` |
| Workflows | Workflow builder components | `/iblai-vibe-workflow` |
| Desktop/mobile | Tauri v2 desktop/mobile shell | `/iblai-vibe-ops-build` |
...
- Auth set up first via `/iblai-vibe-auth` (other components depend on the auth
