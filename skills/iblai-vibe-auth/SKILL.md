...
The parameters, tokens, anonymous access, tenant switching, native shells,
...
> (https://github.com/iblai/vibe/tree/main/skills/iblai-vibe-ops-init/assets/vibe-starter) is a pre-wired Next.js 16 +
 ...
 **Want a complete app from scratch?** Use **vibe-starter** (Step 0 above) —
 ...
 its templates, see [`/iblai-vibe-scaffold`](../iblai-vibe-scaffold/SKILL.md).
...
[`/iblai-vibe-scaffold` → add-command](../iblai-vibe-scaffold/references/add-command.md)):
...
For the route group pattern, see the **vibe-starter** reference app:
  https://github.com/iblai/vibe/tree/main/skills/iblai-vibe-ops-init/assets/vibe-starter
