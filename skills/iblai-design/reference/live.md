...
```
LOOP:
  node .claude/skills/iblai-design/scripts/live-poll.mjs   # default long timeout; no --timeout=
...
node .claude/skills/iblai-design/scripts/live-resume.mjs --id SESSION_ID
...
```bash
node .claude/skills/iblai-design/scripts/live-poll.mjs --reply EVENT_ID done --file RELATIVE_PATH
```
...
```bash
node .claude/skills/iblai-design/scripts/live-poll.mjs --reply EVENT_ID error "Short reason"
```
...
```bash
node .claude/skills/iblai-design/scripts/live-server.mjs stop
```
...
```bash
node .claude/skills/iblai-design/scripts/detect-csp.mjs
```
