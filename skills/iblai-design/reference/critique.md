...
- **Suggested command**: Which command could address this (from: /iblai-design adapt, /iblai-design animate, /iblai-design audit, /iblai-design bolder, /iblai-design clarify, /iblai-design colorize, /iblai-design critique, /iblai-design delight, /iblai-design distill, /iblai-design document, /iblai-design harden, /iblai-design layout, /iblai-design onboard, /iblai-design optimize, /iblai-design overdrive, /iblai-design polish, /iblai-design quieter, /iblai-design shape, /iblai-design typeset)
...
2. **Pass the structured metadata** through `IMPECCABLE_CRITIQUE_META` (JSON), then run the write command:
   ...
   IMPECCABLE_CRITIQUE_META='{"target":"<user phrasing>","total_score":<n>,"p0_count":<n>,"p1_count":<n>}' \
     node .claude/skills/iblai-design/scripts/critique-storage.mjs write <slug> <body-file>
   ```
   The helper prints the absolute path it wrote.

3. **Read the trend** for context:
   ```bash
   node .claude/skills/iblai-design/scripts/critique-storage.mjs trend <slug> 5
   ```
...
- Only recommend commands from: /iblai-design adapt, /iblai-design animate, /iblai-design audit, /iblai-design bolder, /iblai-design clarify, /iblai-design colorize, /iblai-design critique, /iblai-design delight, /iblai-design distill, /iblai-design document, /iblai-design harden, /iblai-design layout, /iblai-design onboard, /iblai-design optimize, /iblai-design overdrive, /iblai-design polish, /iblai-design quieter, /iblai-design shape, /iblai-design typeset
...
- End with `/iblai-design polish` as the final step if any fixes were recommended

After presenting the summary, tell the user:

> You can ask me to run these one at a time, all at once, or in any order you prefer.
>
> Re-run `/iblai-design critique` after fixes to see your score improve.
