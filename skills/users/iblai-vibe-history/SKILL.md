...
description: Add the user profile History surface (review and export conversations with AI agents — Conversations tab with filters and a two-column transcript preview, an Exports tab of generated reports, and an admin/watcher view of other users' history) to your Next.js app
globs:
alwaysApply: false
metadata:
  kind: ui
...
- **Transcript preview** (right) — the selected conversation as
  ...
  with the same date + time-ago header and the
