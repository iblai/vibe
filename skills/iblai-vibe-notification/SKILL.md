...
> (https://github.com/iblai/vibe/tree/main/skills/iblai-vibe-ops-init/assets/vibe-starter) already ships the
...
Run `/iblai-vibe-ops-test` before reporting done:
