...
![Agent Search](https://raw.githubusercontent.com/iblai/vibe/refs/heads/main/skills/agents/iblai-vibe-agent-search/iblai-vibe-agent-search.png)
...
| `mainTenantKey` | `string` | No | Main organization key (default: `"main"`) |
