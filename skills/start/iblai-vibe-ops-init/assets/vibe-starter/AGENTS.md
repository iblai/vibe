...
|---|---|
| "who signs in", "one org or many", "make it multi-organization", "public agent" | `/iblai-vibe-start` (re-run to change the decisions above); mechanics in the vibe repo's `docs/auth-model.md` |
