...
| `tauri/` | the build skill | [`iblai-vibe-ops-build/assets/tauri/`](../../../ship/iblai-vibe-ops-build/assets/tauri/) |
| `icons/` | static copy | [`iblai-vibe-ops-build/assets/icons/`](../../../ship/iblai-vibe-ops-build/assets/icons/) |
...
| `platform_key` | string | ibl.ai platform (organization) key | `.env.example`, `config.ts` |
| `mentor_id` | string | Default agent UUID (agent apps) | `.env.example`, `config.ts`, `page.tsx` |
| `has_mentor_id` | bool | Whether an agent id was supplied | CLAUDE.md / conditional blocks |
